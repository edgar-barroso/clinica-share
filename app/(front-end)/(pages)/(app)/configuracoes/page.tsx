...
const sections: Array<{
...
}> = [
  {
    ...
    description: 'Define os blocos fixos de horário (manhã, tarde, noite) usados para agenda e cálculo de aluguel',
  },
];
...
export default function ConfiguracoesPage() {
  return (
    <>
      <PageHeader title="Configurações" description="Ajustes estruturais da clínica." />
