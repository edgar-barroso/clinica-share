...
| 2026-05-08 | Construção (Fase 1 ✅) | **Construção (Fase 2 — 75% ✅)** | Catálogos CRUD: backend completo (8 rotas API + 14 usecases + 37 testes Vitest novos) para Consultórios, Profissionais+TurnoFixo, Staff. Audit log em alteração de contrato. Frontend: listagem+criação migrada para API real (6 páginas) + 3 specs Playwright E2E. Pendente: 6 páginas de detalhe/editar (não bloqueia Fase 3). Total: 75 testes Vitest + 4 specs Playwright |
